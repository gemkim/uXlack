...
export default function TaskForm({ confirm }: { confirm: () => void }) {
  ...
  return (
    <div className='relative'>
      ...
      {/* error */}
      {errorMessage.isOpen && (
        <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2  border border-[#dbdbdb] bg-white rounded px-[10px] py-[10px] w-full max-w-[80%] text-red-500 text-center z-2 pointer-events-none'>
